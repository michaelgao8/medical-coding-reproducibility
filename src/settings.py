...
DOWNLOAD_DIRECTORY_MIMICIII = (
    "mimicdata/mimiciii"  # Path to the MIMIC-III data. Example: ~/mimiciii/1.4
)
DOWNLOAD_DIRECTORY_MIMICIV = "mimicdata/mimiciv/"  # Path to the MIMIC-IV data. Example: ~/physionet.org/files/mimiciv/2.2
DOWNLOAD_DIRECTORY_MIMICIV_NOTE = "mimicdata/mimiciv"  # Path to the MIMIC-IV-Note data. Example: ~/physionet.org/files/mimic-iv-note/2.2
